...
<div class="wrapper"><!-- not needed? up to you: http://camendesign.com/code/developpeurs_sans_frontieres -->
	...
	<div class="billboard-wrapper billboard-ext-leaders">
		<ul>
			<li><img src="_/img/leadership/monik_sanghvi.jpg" alt="Monik Sanghvi"></li>
			<li><img src="_/img/leadership/satish_korde.jpg" alt="Satish Korde"></li>
			<li><img src="_/img/leadership/scott_lange.jpg" alt="Scott Lange"></li>
		</ul>
	</div>

	<div class="segment-headline-wrapper clear">
		<h2 class="center min-max"><span class="segment-header-spacer">Toby Barlow</span><span class="segment-leader-title">(ECD)</span></h2>
	</div>
