...
<div class="wrapper">
	...
	<div class="segment-headline-wrapper clear">
		<h2 class="center min-max"><a href="../aboutus.php?p=leaders" alt="Back to Leadership"><div class="gridbox">GRID</div></a><span class="segment-header-spacer-ext">Greg Braun</span><span class="segment-leader-title">(EVP, Executive Creative Director)</span></h2>
	</div>
...
<script>
  ...
  _gaq.push(['_trackPageview', 'teamdetroit:about:Greg Braun']);
