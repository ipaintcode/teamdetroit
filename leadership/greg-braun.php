	...
	<div class="content-wrapper">
		...
		<div class="content center min-max clearfix">
			...
			<ul class="secondary-nav">
				<li class="secondary-nav-prev"><a href="linda-talyor.php" class="anchor-tdi">Previous</a></li>
				<li class="secondary-nav-next"><a href="andy-prakken.php" class="anchor-tdi">Next</a></li>
			</ul>
