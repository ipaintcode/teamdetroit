...
<head id="www-sitename-com" data-template-set="html5-reset">
	...
	<meta name="description" content="It's a long way from Mumbai to Dearborn. But the journey is even longer. Especially for Satish Korde, Team Detroit's President and CEO." />

	<title>Satish Korde | President and CEO | Team Detroit</title>
...
<div class="wrapper">
	...
	<div class="segment-headline-wrapper clear">
		<h2 class="center min-max"><a class="anchor-tdi" href="../aboutus.php?p=leaders" alt="Back to Leadership"><div class="gridbox">GRID</div></a><span class="segment-header-spacer-ext">Satish Korde</span><span class="segment-leader-title">(President and CEO)</span></h2>
	</div>
		...
		<div class="content center min-max clearfix">
			...
			<section class="content-info-wrapper double">
				...
				<div class="content-info">
					...
					<p>It’s a long way from Mumbai to Dearborn. But the journey is even longer. Especially for Satish Korde, Team Detroit’s President and CEO.</p>
					...
					<ul class="content-info-social">
						<li>Network &rarr;</li>
						<li class="linkedin"><a href="http://www.linkedin.com/pub/satish-korde/28/78a/843" target="_blank">LinkedIn</a></li>
					</ul>
			...
			<ul class="secondary-nav">
				<li class="secondary-nav-prev"><a href="bob-mcclowry.php" class="anchor-tdi">Previous</a></li>
				<li class="secondary-nav-next"><a href="toby-barlow.php" class="anchor-tdi">Next</a></li>
			</ul>
...
<script>
  ...
  _gaq.push(['_trackPageview', 'teamdetroit:about:Satish_Korde']);
