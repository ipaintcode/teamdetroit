...
<div class="wrapper"><!-- not needed? up to you: http://camendesign.com/code/developpeurs_sans_frontieres -->
	...
	<div class="segment-headline-wrapper clear">
		<h2 class="center min-max"><span class="segment-header-spacer">Monik Sanghvi</span><span class="segment-leader-title">(Chief Digital and Integration Officer)</span></h2>
	</div>
