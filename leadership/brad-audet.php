	...
	<div class="content-wrapper">
		...
		<div class="content center min-max clearfix">
			...
			<ul class="secondary-nav">
				<li class="secondary-nav-prev"><a href="mike-bentley.php" class="anchor-tdi">Previous</a></li>
				<li class="secondary-nav-next"><a href="scott-lange.php" class="anchor-tdi">Next</a></li>
			</ul>
...
<script>
  ...
  _gaq.push(['_trackPageview', 'teamdetroit:about:Brad_Audet']);
