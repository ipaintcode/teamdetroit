...
<div class="wrapper">
	...
	<div class="segment-headline-wrapper clear">
		<h2 class="center min-max"><a href="../aboutus.php?p=leaders" alt="Back to Leadership"><div class="gridbox">GRID</div></a><span class="segment-header-spacer-ext">Brad Audet</span><span class="segment-leader-title">(Managing Director, Business Development)</span></h2>
	</div>
		...
		<div class="content center min-max clearfix">
			...
			<aside class="content-quote-wrapper single">
				...
				<div class="content-quote">
					 ...
					 <blockquote>
					 	<p>It’s not how you play the game; it’s whether or not you win.</p>
					 	<p class="content-quote-author">&ndash; Brad Audet</p>
					 </blockquote>
			...
			<ul class="secondary-nav">
				<li class="secondary-nav-prev"><a href="mike-bentley.php">Previous</a></li>
				<li class="secondary-nav-next"><a href="scott-lange.php">Next</a></li>
			</ul>
...
<script>
  ...
  _gaq.push(['_trackPageview', 'teamdetroit:about:Brad Audet']);
