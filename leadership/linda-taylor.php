...
<head id="www-sitename-com" data-template-set="html5-reset">
	...
	<meta name="description" content="With over a decade in the business at agencies, Linda has attracted and retained some of the leading talent all over the world." />

	<title>Linda Taylor | Chief Talent Officer | Team Detroit</title>
...
<div class="wrapper">
	...
	<div class="segment-headline-wrapper clear">
		<h2 class="center min-max"><a class="anchor-tdi" href="../aboutus.php?p=leaders" alt="Back to Leadership"><div class="gridbox">GRID</div></a><span class="segment-header-spacer-ext">Linda Taylor</span><span class="segment-leader-title">(Chief Talent Officer)</span></h2>
	</div>
	...
	<div class="content-wrapper">
		...
		<div class="content center min-max clearfix">
			...
			<section class="content-info-wrapper double">
				...
				<div class="content-info">
					...
					<ul class="content-info-social">
						<li>Network &rarr;</li>
						<li class="linkedin"><a href="http://www.linkedin.com/pub/linda-taylor/1/836/447" target="_blank">LinkedIn</a></li>
					</ul>
			...
			<ul class="secondary-nav">
				<li class="secondary-nav-prev"><a href="paul-venn.php" class="anchor-tdi">Previous</a></li>
				<li class="secondary-nav-next"><a href="greg-braun.php" class="anchor-tdi">Next</a></li>
			</ul>
