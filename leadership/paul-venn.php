...
<head id="www-sitename-com" data-template-set="html5-reset">
	...
	<meta name="description" content="Paul is responsible for leading and coordination the marketing communications for Ford on a global scale." />

	<title>Paul Venn | President, Client Services, Global Team Ford | Team Detroit</title>
...
<div class="wrapper">
	...
	<div class="segment-headline-wrapper clear">
		<h2 class="center min-max"><a class="anchor-tdi" href="../aboutus.php?p=leaders" alt="Back to Leadership"><div class="gridbox">GRID</div></a><span class="segment-header-spacer-ext">Paul Venn</span><span class="segment-leader-title">(President, Client Services, Global Team Ford)</span></h2>
	</div>
	...
	<div class="content-wrapper">
		...
		<div class="content center min-max clearfix">
			...
			<section class="content-info-wrapper double">
				...
				<div class="content-info">
					...
					<ul class="content-info-social">
						<li>Network &rarr;</li>
						<li class="linkedin"><a href="http://www.linkedin.com/pub/paul-venn/7/585/704" target="_blank">LinkedIn</a></li>
					</ul>
			...
			<aside class="content-quote-wrapper single">
				...
				<div class="content-quote">
					 ...
					 <blockquote>
					 	...
					 	<p class="content-quote-author">&ndash; Paul Venn</p>
					 </blockquote>
			...
			<ul class="secondary-nav">
				<li class="secondary-nav-prev"><a href="sharon-wacker.php" class="anchor-tdi">Previous</a></li>
				<li class="secondary-nav-next"><a href="linda-taylor.php" class="anchor-tdi">Next</a></li>
			</ul>
...
<script>
  ...
  _gaq.push(['_trackPageview', 'teamdetroit:about:Paul_Venn']);
