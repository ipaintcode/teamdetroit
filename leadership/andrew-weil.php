	...
	<div class="content-wrapper">
		...
		<div class="content center min-max clearfix">
			...
			<aside class="content-quote-wrapper single">
				...
				<div class="content-quote">
					 ...
					 <blockquote>
					 	...
					 	<p class="content-quote-author">&ndash; Andy Weil</p>
					 </blockquote>
			...
			<ul class="secondary-nav">
				<li class="secondary-nav-prev"><a href="michele-silvestri.php" class="anchor-tdi">Previous</a></li>
				<li class="secondary-nav-next"><a href="bob-mcclowry.php" class="anchor-tdi">Next</a></li>
			</ul>
...
<script>
  ...
  _gaq.push(['_trackPageview', 'teamdetroit:about:Andrew J. Weil']);
