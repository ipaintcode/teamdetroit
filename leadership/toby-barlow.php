...
<div class="wrapper">
	...
	<div class="segment-headline-wrapper clear">
		<h2 class="center min-max"><a href="../aboutus.php?p=leaders" alt="Back to Leadership"><div class="gridbox">GRID</div></a><span class="segment-header-spacer-ext">Toby Barlow</span><span class="segment-leader-title">(Chief Creative Officer)</span></h2>
	</div>
	...
	<div class="content-wrapper">
		...
		<div class="content center min-max clearfix">
			...
			<ul class="secondary-nav">
				<li class="secondary-nav-prev"><a href="satish-korde.php">Previous</a></li>
				<li class="secondary-nav-next"><a href="mike-bentley.php">Next</a></li>
			</ul>
