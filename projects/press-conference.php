...
<div class="wrapper">
	...
	<div class="segment-headline-wrapper clear below-carousel">
		...
		<h2 class="center min-max"><a href="../work.php" alt="Back to Work"><div class="gridbox">GRID</div></a><span class="segment-header-spacer-ext">Totally Unexpected Press Conference</span></h2>
	...
	<div class="content-wrapper">
		...
		<div class="content center min-max clearfix">
			...
			<ul class="secondary-nav">
				<li class="secondary-nav-prev"><a href="lincoln-innovators.php">Previous</a></li>
				<li class="secondary-nav-next"><a href="scotts.php">Next</a></li>
			</ul>
