...
<div class="wrapper">
	...
	<div class="billboard-wrapper billboard-ext-carousel">
		<ul class="fluidCarousel">
			<li class="activeCarousel">
				...
				<div class="youtube-video-holder" data="AYTGnB5InaY"></div>
			</li>
			<li class="">
				<div class="close-video">x</div>
				<h4></h4>
	...
	<div class="segment-headline-wrapper clear below-carousel">
		...
		<h2 class="center min-max"><a class="anchor-tdi" href="../work.php" alt="Back to Work"><div class="gridbox">GRID</div></a><span class="segment-header-spacer-ext">Totally Unexpected Press Conference</span></h2>
	...
	<div class="content-wrapper">
		...
		<div class="content center min-max clearfix">
			...
			<ul class="secondary-nav">
				<li class="secondary-nav-prev"><a href="lincoln-innovators.php" class="anchor-tdi">Previous</a></li>
				<li class="secondary-nav-next"><a href="scotts.php" class="anchor-tdi">Next</a></li>
			</ul>
...
<script>
  ...
  _gaq.push(['_trackPageview', 'teamdetroit:work:Totally Unexpected Press Conference']);
