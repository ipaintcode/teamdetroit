		...
		<div class="content center min-max clearfix">
			...
			<section class="content-info-wrapper double">
				...
				<article class="content-info">
					...
					<p>To show why Super Duty dominates in such numbers, we’re creating documentary-style videos that showcase real companies and real workers who use Super Duty trucks in their jobs. And we’re tying each story to a specific industry: Oil & Gas, Mining, Heavy Construction, etc.</p>
