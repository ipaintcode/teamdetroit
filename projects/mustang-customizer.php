...
<div class="wrapper">
	...
	<div class="segment-headline-wrapper clear below-carousel">
		...
		<h2 class="center min-max"><a class="anchor-tdi" href="../work.php" alt="Back to Work"><div class="gridbox">GRID</div></a><span class="segment-header-spacer-ext">Mustang Customizer</span></h2>
	...
	<div class="content-wrapper">
		...
		<div class="content center min-max clearfix">
			...
			<section class="content-info-wrapper double">
				...
				<article class="content-info">
					...
					<ul class="content-links">Related Links
						...
						<li><a href="http://www.facebook.com/fordmustang?C5=fv-ext-a1b07c16d000721e14f12g03h14j11k22m4n0p20110607">Check out Mustang Customizer on Facebook</a></li>
						<li><a href="http://itunes.apple.com/us/app/mustang-customizer/id466530587?ls=1&mt=8">Download the Mustang Customizer iPhone App</a></li>
						<li><a href="https://market.android.com/details?id=com.ford.mustangcustomizer">Download the Mustang Customizer Android App</a></li>
					</ul>
			...
			<ul class="secondary-nav">
				<li class="secondary-nav-prev"><a href="we-own-work.php" class="anchor-tdi">Previous</a></li>
				<li class="secondary-nav-next"><a href="f150-torture-test.php" class="anchor-tdi">Next</a></li>
			</ul>
...
<script>
  ...
  _gaq.push(['_trackPageview', 'teamdetroit:work:Mustang_Customizer']);
