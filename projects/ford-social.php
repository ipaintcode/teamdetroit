...
<head id="www-sitename-com" data-template-set="html5-reset">
	...
	<meta name="description" content="Some call this a conversation. We call it Ford Social." />

	<title>Ford Social | Team Detroit</title>
...
<div class="wrapper">
	...
	<div class="segment-headline-wrapper clear below-carousel">
		...
		<h2 class="center min-max"><a class="anchor-tdi" href="../work.php" alt="Back to Work"><div class="gridbox">GRID</div></a><span class="segment-header-spacer-ext">Ford Social</span></h2>
	...
	<div class="content-wrapper">
		...
		<div class="content center min-max clearfix">
			...
			<ul class="secondary-nav">
				<li class="secondary-nav-prev"><a href="ohio-art.php" class="anchor-tdi">Previous</a></li>
				<li class="secondary-nav-next"><a href="warrior.php" class="anchor-tdi">Next</a></li>
			</ul>
...
<script>
  ...
  _gaq.push(['_trackPageview', 'teamdetroit:work:Ford_Social']);
