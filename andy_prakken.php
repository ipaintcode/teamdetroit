...
<div class="wrapper"><!-- not needed? up to you: http://camendesign.com/code/developpeurs_sans_frontieres -->
	...
	<div class="headline-wrapper">
		<h2 class="center min-max" style="font-size:16px;"><span>Andy Prakken<span class="headline-leader-ext">(Chief Media Officer)</span></span></h2>
	</div>
