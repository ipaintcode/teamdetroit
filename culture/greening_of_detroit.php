...
<head id="www-sitename-com" data-template-set="html5-reset">
	...
	<meta name="description" content="We work with hundreds of community partners in Detroit, Hamtramck and Highland Park to improve parks, beautify neighborhoods and create useful landscapes from vacant land. " />

	<title>Greening of Detroit | Team Detroit</title>
...
<div class="wrapper">
	...
	<div class="billboard-wrapper billboard-ext-carousel">
		<ul class="fluidCarousel">
			<li class="activeCarousel"><img src="../_/img/culture/greening_of_detroit/billboard-1.jpg" alt=""></li>
			<li class=""><img src="../_/img/culture/greening_of_detroit/billboard-2.jpg" alt=""></li>
			<li class=""><img src="../_/img/culture/greening_of_detroit/billboard-3.jpg" alt=""></li>
			<li class=""><img src="../_/img/culture/greening_of_detroit/billboard-4.jpg" alt=""></li>
			<li class=""><img src="../_/img/culture/greening_of_detroit/billboard-5.jpg" alt=""></li>
			<li class=""><img src="../_/img/culture/greening_of_detroit/billboard-6.jpg" alt=""></li>
			<li class=""><img src="../_/img/culture/greening_of_detroit/billboard-7.jpg" alt=""></li>
			<li class=""><img src="../_/img/culture/greening_of_detroit/billboard-8.jpg" alt=""></li>												
		</ul>
	</div>

	<div class="segment-headline-wrapper clear below-carousel">
		
		<h2 class="center min-max"><a class="anchor-tdi" href="../culture.php" alt="Back to Culture"><div class="gridbox">GRID</div></a><span class="segment-header-spacer-ext">Greening of Detroit</span></h2>
	...
	<div class="content-wrapper">
		...
		<div class="content center min-max clearfix">
			...
			<ul class="secondary-nav">
				<li class="secondary-nav-prev"><a href="love_detroit.php" class="anchor-tdi">Previous</a></li>
				<li class="secondary-nav-next"><a href="movember.php" class="anchor-tdi">Next</a></li>
			</ul>
