...
<div class="wrapper">
	...
	<div class="billboard-wrapper billboard-ext-carousel">
		<ul class="fluidCarousel">
			...
			<li class=""><img src="../_/img/culture/motorcity_pride/billboard-3.jpg" alt=""></li>
			<li class=""><img src="../_/img/culture/motorcity_pride/billboard-4.jpg" alt=""></li>											
		</ul>
	</div>

	<div class="segment-headline-wrapper clear below-carousel">
		
		<h2 class="center min-max"><a href="../culture.php" alt="Back to Culture"><div class="gridbox">GRID</div></a><span class="segment-header-spacer-ext">Motorcity Pride</span></h2>
	...
	<div class="content-wrapper">
		...
		<div class="content center min-max clearfix">
			...
			<ul class="secondary-nav">
				<li class="secondary-nav-prev"><a href="movember.php">Previous</a></li>
				<li class="secondary-nav-next"><a href="signal_return.php">Next</a></li>
			</ul>
...
<script>
  ...
  _gaq.push(['_trackPageview', 'teamdetroit:culture:Motorcity Pride']);
