...
<head id="www-sitename-com" data-template-set="html5-reset">
	...
	<meta name="description" content="Team Detroit created 'People Mover' to showcase the many talented individuals who make Detroit such a special place to live and work. " />
	
	<title>People Mover | Team Detroit</title>
...
<div class="wrapper">
	...
	<div class="segment-headline-wrapper clear below-carousel">
		...
		<h2 class="center min-max"><a class="anchor-tdi" href="../culture.php" alt="Back to Culture"><div class="gridbox">GRID</div></a><span class="segment-header-spacer-ext">People Mover</span></h2>
	...
	<div class="content-wrapper">
		...
		<div class="content center min-max clearfix">
			...
			<ul class="secondary-nav">
				<li class="secondary-nav-prev"><a href="signal_return.php" class="anchor-tdi">Previous</a></li>
				<li class="secondary-nav-next"><a href="love_detroit.php" class="anchor-tdi">Next</a></li>
			</ul>
...
<script>
  ...
  _gaq.push(['_trackPageview', 'teamdetroit:culture:People_Mover']);
