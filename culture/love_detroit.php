...
<div class="wrapper"><!-- not needed? up to you: http://camendesign.com/code/developpeurs_sans_frontieres -->
	...
	<div class="billboard-wrapper billboard-ext-leaders">
		<ul>
			<li><img src="../_/img/culture/love_detroit/billboard-4.jpg" alt=""></li>
			<li><img src="../_/img/culture/love_detroit/billboard-1.jpg" alt=""></li>
			<li><img src="../_/img/culture/love_detroit/billboard-2.jpg" alt=""></li>
		</ul>
	</div>
